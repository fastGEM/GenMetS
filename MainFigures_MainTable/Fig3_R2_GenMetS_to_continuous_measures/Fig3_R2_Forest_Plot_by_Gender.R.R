...
#mywd <- "/Users/TEHAL/OneDrive - A STAR/Misc/"
mywd <- "C:/Users/tehal/OneDrive - A STAR/Misc/"
setwd(mywd)
data_all <- fread("Coefficient_determination_GenMetS_to_continoustraits_CI_modified.txt")
...
tiff("Fig3_Forest_plot_by_gender.tiff", width = 12, height = 7, units = "in",
