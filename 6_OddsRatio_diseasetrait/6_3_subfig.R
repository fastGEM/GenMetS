...
############################UKB WOMEN
myresult_raw1<- fread(paste0("OddsRatio_diseases_UKB.txt")) %>% data.frame()
myresult_raw2<- fread(paste0("OddsRatio_diseases_ATTaACT.txt")) %>% data.frame()
...
ggsave("SubFig4A_UKB_ASN_men_women.tiff", combined_plot1, width =8, height =12, units = "in",dpi = 300, compression = "lzw")
ggsave("SubFig4A_UKB_ASN_men_women.pdf", combined_plot1, width =8, height =12, units = "in" )
...
ggsave("SubFig4B_ATTRACT_men_women.tiff", combined_plot2, width =8, height =12, units = "in",dpi = 300, compression = "lzw")
ggsave("SubFig4B_ATTRACT_men_women.pdf", combined_plot2, width =8, height =12, units = "in" )
